...
from finetune_llama import model_provider
...
def load_megatron_model(args):
    ...
    state_dict["embedding.word_embeddings.weight"] = state_dict["embedding.word_embeddings.weight"][:128384,:]
    state_dict["output_layer.weight"] = state_dict["output_layer.weight"][:128384,:]
...
def convert_checkpoint_from_megatron_to_transformers(mgmodel, hfmodel, args):
    ...
    with torch.no_grad():
        ...
        hfmodel.model.embed_tokens.weight.copy_(
            mgmodel.embedding.word_embeddings.weight[:128256,:]
        )
        ...
        hfmodel.lm_head.weight.copy_(mgmodel.output_layer.weight[:128256,:])
...
def main():
    ...
    print("args.convert_checkpoint_from_megatron_to_transformers: ", args.convert_checkpoint_from_megatron_to_transformers)
